...
function getEnvConfig(): Partial<ApiConfig> {
  return {
    ...
    defaultTimeout: import.meta.env.VITE_API_DEFAULT_TIMEOUT ? 
      parseInt(import.meta.env.VITE_API_DEFAULT_TIMEOUT, 10) : undefined,
    maxRetries: import.meta.env.VITE_API_MAX_RETRIES ? 
      parseInt(import.meta.env.VITE_API_MAX_RETRIES, 10) : undefined,
    enableRetry: import.meta.env.VITE_API_ENABLE_RETRY !== 'false',
    
    loggingEnabled: import.meta.env.VITE_API_LOGGING_ENABLED === 'true',
    logLevel: (import.meta.env.VITE_API_LOG_LEVEL as ApiConfig['logLevel']) || undefined,
    ...
    logMaxEntries: import.meta.env.VITE_API_LOG_MAX_ENTRIES ? 
      parseInt(import.meta.env.VITE_API_LOG_MAX_ENTRIES, 10) : undefined,
    
    enableTokenRefresh: import.meta.env.VITE_API_ENABLE_TOKEN_REFRESH !== 'false',
    enableRequestDeduplication: import.meta.env.VITE_API_ENABLE_REQUEST_DEDUPPLICATION !== 'false',
    ...
    enablePerformanceTracking: import.meta.env.VITE_ENABLE_PERFORMANCE_TRACKING === 'true',
  };
}
 ...
 */
export function getEnvironmentConfig(env: 'development' | 'staging' | 'production'): Partial<ApiConfig> {
...
export function initializeApiConfig(): void {
  ...
  if (merged.isDevelopment) {
    ...
    console.log('Environment:', merged.isDevelopment ? 'development' : 'production');
